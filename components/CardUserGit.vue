...
<template>
  <div class="bg-card flex flex-grow gap-6 rounded-xl w-full max-w-lg xl:max-w-1/2 p-6 h-full">
    ...
    <div class="flex-col w-full">
      ...
      <div class="grid items-center grid-cols-2 grid-rows-2 gap-4 p-4 *:text-text">
